...
class Hostinger_Ai_Assistant_Content_Generation {
	...
	public function validate_voice_tone( $voice_tone ): string {
		$allowed_voice_tones = array( 'casual', 'neutral', 'formal' );

		return in_array( $voice_tone, $allowed_voice_tones ) ? $voice_tone : 'neutral';
	}
