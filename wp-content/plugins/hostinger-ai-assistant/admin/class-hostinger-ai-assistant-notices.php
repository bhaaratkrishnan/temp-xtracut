...
class Hostinger_Ai_Assistant_Notices {
	...
	public function api_token_plugin_notice() { ?>
		...
		<div class="notice notice-error is-dismissible hts-theme-settings">
			<p>
				<strong><?= __( 'Attention:', 'hostinger-blog-theme' ) ?></strong> <?= __( 'To unlock the exclusive features of <b>Hostinger AI Assistant</b>, you must possess a unique API token, which is exclusively provided to Hostinger clients', 'hostinger-ai-assistant' ) ?>
			</p>
		</div>
