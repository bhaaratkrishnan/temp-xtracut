			...
			<div class="hts-inputs-wrapper">
				...
				<div class="hts-input-item">
					<div class="container">
						...
						<div class="wrapper-dropdown" id="dropdown">
								<span class="selected-display" id="hts-voice-tone" data-value="<?= __( 'Formal', 'hostinger-ai-assistant' )?>"><?= __( 'Casual', 'hostinger-ai-assistant' )?></span>
							<svg id="drp-arrow" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="hts-arrow transition-all ml-auto">
								<path fill-rule="evenodd" clip-rule="evenodd" d="M7 10L12 15L17 10H7Z" fill="#727586"/>
							</svg>
							<ul class="dropdown">
								<li class="item active" data-value="casual">
									<?= __( 'Casual', 'hostinger-ai-assistant' )?>
								</li>
								<li class="item" data-value="neutral"><?= __( 'Neutral', 'hostinger-ai-assistant' )?></li>
								<li class="item" data-value="formal"><?= __( 'Formal', 'hostinger-ai-assistant' )?></li>
							</ul>
						</div>
					</div>
					<div class="hts-input-description">
